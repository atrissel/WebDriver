...
//		}
		...
		for (String project : projectList){
			...
			for (int second = 0;; second++) {
				if (second >= 1000) fail("timeout");
				try { if (driver.findElement(By.cssSelector("BODY")).getText().contains("The project import completed")) break; } catch (Exception e) {}
				Thread.sleep(1000);
			}

			driver.findElement(By.id("ok_submit")).click();
			//driver.get(baseUrl + "/secure/admin/ProjectImportSelectProject!default.jspa");
